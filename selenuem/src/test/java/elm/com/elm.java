...
public void REVIEW () throws InterruptedException
{
	driver.findElement(By.cssSelector("button.LkLjZd.ScJHi.HPiPcc.id-track-click ")).click();	
	 //driver.manage().timeouts().implicitlyWait(100, TimeUnit.SECONDS); 
	//driver.findElement(By.xpath("//textarea[@class='write-review-comment']")).sendKeys("qq");
	//driver.manage().timeouts().implicitlyWait(200, TimeUnit.SECONDS); 
    //Thread.sleep(3000);
	//driver.findElement(By.xpath("//*[@id=\'fifth-star-tip\']")).click();
	WebDriverWait wait=new WebDriverWait(driver, 60);
	WebElement guru99seleniumlink;
	guru99seleniumlink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//textarea[@class=\'review-input-text-box write-review-comment\']")));
	//guru99seleniumlink.click();
	guru99seleniumlink.sendKeys("1000");
	//System.out.println(guru99seleniumlink);
//	System.out.println("8888888888888888888888888888888888888888888888888888888");
//	System.out.println("8888888888888888888888888888888888888888888888888888888");
//	System.out.println("8888888888888888888888888888888888888888888888888888888");
//	System.out.println(driver.findElement(By.className("button.fifth-star"))); //.click();
//	System.out.println("8888888888888888888888888888888888888888888888888888888");
